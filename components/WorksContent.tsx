  ...
  const conceptWorks = [
    {
      ...
      imagePlaceholder: "Identity Design"
    },
    {
      id: 2,
      ...
      imagePlaceholder: "Platform UI/UX"
    },
    {
      id: 3,
      title: "Marketing Web",
      ...
      imagePlaceholder: "Marketing Web"
    }
  ];
              ...
              >
                ...
                >
                  <div style={{ textAlign: 'center', color: '#60a5fa' }}>
                    ...
                    <p style={{ fontSize: '12px', letterSpacing: '0.1em', fontFamily: 'serif' }}>{work.imagePlaceholder}</p>
                  </div>
                </motion.div>
